...
public class _02_NextPrevAbsRel extends JDBCParent {
    ...
    public void NextPrev() throws SQLException {
        ...
        System.out.println("1. satir dilAdi = " + rs.getString(2)); // 2 column sırası
                                                // rs.getString(name)

        rs.next(); // 2.satır
        System.out.println("2. satir dilAdi = " + rs.getString(2));

        rs.next(); // 3.satır
        System.out.println("3. satir dilAdi = " + rs.getString(2));
    ...
    public void AbsoluteRelative() throws SQLException {
        ...
        rs.relative(5); // 15. satıra gider. niye? en son bulunduğu yerden 5 satır gider
        System.out.println("15.satır - title = " + rs.getString("title"));

        rs.absolute(-10); // sondan 10.satır
